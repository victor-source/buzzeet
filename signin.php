                ...
                <div class="row no-gutters">
                    <div class="col-md-6 text-center pt-5">
                        <div class="sign-in-detail text-white">
                            <a class="sign-in-logo mb-5" href="#"><img src="images/loader.png" class="img-fluid" alt="logo"></a>
                    ...
                    <div class="col-md-6 bg-white pt-5">
                        <div class="sign-in-from">
                            ...
                            <p>Enter your email address and password to access our exciting community.</p>
                            <form class="mt-4" method="post">
                              <?php echo $msg ?>
                                ...
                                <div class="sign-info">
                                    <span class="dark-color d-inline-block line-height-2">Don't have an account? <a href="signup.php">Sign up</a></span>
